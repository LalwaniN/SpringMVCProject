	...
	<div style="margin-top: 5%;" class="container">
		...
		<table class="table table-bordered" >
          ...
          #${event.eventCategory.eventType}      
            ...
            <td>
            <a href="${contextPath}/admin/approveevent?eventId=${event.eventId}" class="form-control btn btn-primary">APPROVE</a> &nbsp
             <a href="${contextPath}/admin/rejectevent?eventId=${event.eventId}" class="form-control btn btn-primary">REJECT</a>
            </td>
